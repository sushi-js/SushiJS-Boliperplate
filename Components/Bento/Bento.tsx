...
export default function Bento() {
  return (
    <div className='relative bg-white dark:bg-black pt-16 px-4 sm:px-6 lg:pt-24 lg:px-8'>
      <div className='bg-white dark:bg-black h-1/3 sm:h-2/3' />
      <div className='relative max-w-7xl mx-auto'>
        <div className='text-center'>
          <h2 className='py-8 text-3xl tracking-tight font-extrabold sm:text-4xl dark:text-white'>
            Nuestros Clientes
          </h2>
